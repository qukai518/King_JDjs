...
更新时间：2021-7-25
备注：高速并发抢京豆，专治偷助力。
设置环境变量angryBeanPins为指定账号助力，默认不助力。
助力模板：export angryBeanPins="['1', '2', '3']" 
设置环境变量angryBeanMode可选值priority(优先模式)、smart(智能模式)和speed(极速模式)，默认speed模式。
...
const speed = "speed"
const smart = "smart"
var pins = $.isNode() ? (process.env.angryBeanPins ? process.env.angryBeanPins : "qukai518_m@宋盼盼1990") : "";
let cookiesArr = [];
var helps = [];
var tools = [];
var maxTimes = 3;
