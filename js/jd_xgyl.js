...
[task_local]
#小鸽有礼2
10 0,7 * * * https://gitee.com/lxk0301/jd_scripts/raw/master/jd_xgyl.js, tag=小鸽有礼2, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_xgyl.png, enabled=true

================Loon==============
[Script]
cron "10 0,7 * * *" script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_xgyl.js, tag=小鸽有礼2

===============Surge=================
小鸽有礼2 = type=cron,cronexp="10 0,7 * * *",wake-system=1,timeout=3600,script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_xgyl.js

============小火箭=========
小鸽有礼2 = type=cron,script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_xgyl.js, cronexpr="10 0,7 * * *", timeout=3600, enable=true
 */
const $ = new Env('小鸽有礼2');
...
function taskUrl(function_id, body) {
  return {
    ...
    body: JSON.stringify([{"userNo": "$cooMrdGatewayUid$", "activityCode": "1410048365793640448", ...body}]),
    headers: {
